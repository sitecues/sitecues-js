...
build:
	...
	echo "sitecues.branch='$(version)';sitecues.version='$(custom-version)';" > target/build-config/config.js
...
debug:
	...
	@mkdir -p $(build-dir)/js
	@mkdir -p target/build-config
	echo "sitecues.branch='$(version)';sitecues.version='$(custom-version)';var SC_LOCAL=$(sc-local),SC_DEV=true,SC_UNIT=false;" > target/build-config/config.js
