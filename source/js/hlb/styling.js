...
sitecues.def('hlb/styling', function (hlbStyling, callback) {
  ...
  sitecues.use('jquery', 'platform', 'util/common', 'util/positioning',
  function ($, platform, common, positioning) {
    ...
    function getBulletWidth ($element, elementComputedStyle) {
      ...
      if ($element.is('ul, ol') && elementComputedStyle['list-style-type'] !== 'none') {
        return positioning.getBulletWidth($element, elementComputedStyle, elementComputedStyle['list-style-type']);
      }
