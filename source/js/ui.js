...
sitecues.def('ui', function (ui, callback) {
  ...
  ui.CONSTANTS = {
    ...
    'SITECUES_CSS_DEFAULT' : 
      ...
      '#sitecues-slider-wrap {display:block;width:340px;height:80px;-webkit-user-select : none; -moz-user-select: none;-o-user-select: none; user-select: none;}\n' +
      '#sitecues-slider-wrap > * {-webkit-user-select: none;-moz-user-select: none;-o-user-select: none;user-select: none;}\n' +
