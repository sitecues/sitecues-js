...
sitecues.def('ui', function (ui, callback, log) {
  ...
  ui.CONSTANTS = {
    ...
    'SITECUES_CSS_DEFAULT' : 
      ...
      '.sitecues-badge {opacity : 0;z-index: 2147483645;margin: 0px;visibility: visible;position: fixed;width: 150px;top: 5px;-webkit-box-sizing: content-box; /* Safari/Chrome, other WebKit */-moz-box-sizing: content-box;/* Firefox, other Gecko */box-sizing: content-box;/* Opera/IE 8+ */}\n' +
