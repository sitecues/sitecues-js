define(
  ...
  function () {
    return {
      verbalCueHighZoom :
        'Bonjour! Vous pouvez zoomer sur certaines parties de cette page web en plaçant votre souris sur le texte que vous souhaitez lire et en appuyant sur la barre d\’espace.',
      verbalCueSpeechOff :
        'Diction desactivée.',
      verbalCueSpeechOn :
        'Diction activée.',
