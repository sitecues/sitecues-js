define(['bp/constants', 'bp/helper', 'bp/model/state', 'core/platform', 'core/metric', 'bp-expanded/bp-expanded'],
  function (BP_CONST, helper, state, platform, metric, bpExpanded) {
