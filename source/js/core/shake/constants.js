define([], function () {
  ...
  return {
    ...
    POSITIONS_ARRAY_SIZE: 10,       // Number of mouse positions stored
    ...
    MAX_SHAKE_VIGOR_DECREASE: 30,   // Maximum speed of shake decrease
    SHAKE_DECREASE_DIVISOR: 1.5,    // Magic value for shake decreases based on mouse speed
