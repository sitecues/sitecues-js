...
define(['page/dollar/zepto'], function () {
          ...
          function applyValue(collection, property, value) {
            ...
            if (!value && value !== 0)
              collection.each(function () {
                this.style.removeProperty(dasherize(vendorName))
              })
            else {
              valueWithPx = maybeAddPx(property, value)
              collection.each(function () {
...
//     Zepto.js may be freely distributed under the MIT license.
  ...
  if (SC_DEV) {
    sitecues.$ = Zepto;  // Helpful for debugging
  }
  return Zepto;
});