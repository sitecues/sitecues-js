...
sitecues.def('ui-manager', function(uiManager, callback) {
        ...
        sitecues.use('jquery', 'conf', 'conf/site', 'toolbar', 'badge', function($, conf, site, toolbar, badge) {
                ...
                var innerToggle = function(callback) {
                    ...
                    badge.isBadgeRaplacedByToolbar = isBadgeInDom && $badge.attr('data-toolbar-will-replace') === 'true' // extension-based script
                ...
                if (DEV) { === === =
                    ...
                    if (UNIT) { >>> >>> > b1a01392ec340478fd4971ab05f3dd0afbafe394
