...
sitecues.def('cursor/images/mac', function (osImages, callback) {
  ...
  sitecues.use('platform', function (platform) {
    ...
    function prepareCursor (size, type) {
      ...
      var  cursorSVG = { 0: '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" '+
        ...
        'scale('+(size)+','+(size)+')" filter="url(#f1)"><path fill="#FFF" d="M1.016,0.422 L1.031,16.781 L4.312,13.281 L6.446,18.479 L10.344,17.031 L8.062,11.875 L12.496,11.871 L1.016,0.422 z" /><path fill="#000" d="M1.938,2.875 L2.031,14.188 L4.531,11.625 L6.969,17.312 L9.031,16.562 L6.688,10.938 L10,10.938"/></g></svg>'        
