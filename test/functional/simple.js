            ...
            suite('HLB Simple', function () {
                ...
                test('HLB Respects Text', function () {
                    return this.remote               // represents the browser being tested
                        ...
                        .getVisibleText()
                        .then(function (text) {
                            assert.strictEqual(text, 'Reach and delight more people with zoom & speech built right into your site.', 'The HLB should contain the same text as the picked element.');
                        });
                });
            });
        }
