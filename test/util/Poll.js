    ...
    function (Base, pollUntil) {
        ...
        class Poll extends Base {
            ...
            untilElementStabilizes(selector, wait, pollInterval, elementAttributes, styleAttributes, rectAttributes) {
                ...
                return this.remote
                    .then(pollUntil(function (selector, attributes, stabilityThreshold) {
                        var namespace  = window.sitecuesTestingNamespace = window.sitecuesTestingNamespace || {},
                            attributeValues = [],
                    ...
                    .execute(function () {
                        window.sitecuesTestingNamespace.savedValues = undefined;
                        window.sitecuesTestingNamespace.stability   = undefined;
                    })
            }
        }
