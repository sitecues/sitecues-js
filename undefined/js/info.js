...
sitecues.define("info/info", [ "$", "run/conf/site", "run/conf/urls", "hlb/dimmer", "run/platform", "run/locale", "page/util/color", "run/events", "run/util/ids", "mini-core/native-global", "run/inline-style/inline-style" ], function($, site, urls, dimmer, platform, locale, colorUtil, events, ids, nativeGlobal, inlineStyle) {
